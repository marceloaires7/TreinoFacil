...
App para registrar treinos de academia, montar a rotina da semana e acompanhar a
evolução. Instala no celular como aplicativo e guarda tudo numa **Planilha
Google**.

Desenvolvido para a **Atividade de Sistematização** da disciplina
...
**O problema.** Quem treina costuma anotar séries, repetições e cargas no papel
ou no bloco de notas do celular — vira bagunça, o histórico se perde e fica
difícil acompanhar a evolução.

**A solução.** Um app que centraliza o registro dos exercícios, mostra o que
treinar em cada dia da semana e deixa marcar o que já foi feito.
...
- **As 4 operações CRUD** sobre os exercícios (cadastrar, listar, editar, excluir),
  com busca por nome e filtros por grupo muscular e por treino.
- **Agenda da semana** — define qual treino cai em cada dia, com um botão para
  abrir o treino daquele dia já filtrado.
- **Checklist semanal** — marca o treino do dia como feito, com barra de
  progresso. Zera sozinho toda segunda e guarda as semanas anteriores.
- **Vídeo do exercício** — cada exercício pode guardar o link de um vídeo
...
| Abrir o treino do dia | Agenda | `verTreino()` | — (só filtra em memória) |
